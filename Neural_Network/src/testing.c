...
void test_AND(void)
{
	...
	saveInputs(inputs, "toLearn_AND");

	Inputs *inputs_loaded = loadInputs("toLearn_AND");
	...
	saveNetwork(network, "test_AND");

	// Loading:

	NeuralNetwork *network_loaded = loadNetwork("test_AND", max_batch_size);
